...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post contestants_url, params: { contestant: { cellphone: @contestant.cellphone, contest_id: @contestant.contest_id, lastname: @contestant.lastname, mail: @contestant.mail, name: @contestant.name } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { cellphone: @contestant.cellphone, contest_id: @contestant.contest_id, lastname: @contestant.lastname, mail: @contestant.mail, name: @contestant.name } }
